...
public class ManagerService {
    ...
    @Transactional
    public ManagerSaveResponse saveManager(CustomUserPrincipal customUserPrincipal, long todoId, ManagerSaveRequest managerSaveRequest) {
        // 일정을 만든 유저
    ...
    @Transactional
    public void deleteManager(CustomUserPrincipal customUserPrincipal, long todoId, long managerId) {
        User user =customUserPrincipal.getUser();
